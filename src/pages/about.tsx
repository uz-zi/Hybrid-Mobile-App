  ...
  return (
    <IonPage>
      ...
      <IonContent className="ion-padding">
        ...
        <IonImg src="/assets/imgs/about-main.jpg" alt="App illustration" className="ion-margin-vertical" />
        ...
        <IonImg src="/assets/imgs/location-preview.png" alt="Location Screenshot" className="ion-margin-vertical" />
        ...
        <IonCard>
          <IonCardHeader>
            <IonCardTitle>⭐ 4.5/5 - Fatima Zahra</IonCardTitle>
          </IonCardHeader>
          <IonCardContent>
